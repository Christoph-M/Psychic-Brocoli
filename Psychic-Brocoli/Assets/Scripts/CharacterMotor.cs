...
public class CharacterMotor : MonoBehaviour 
{
	...
	private void UpdateFunction()
	{
		...
		//The CharacterController can be moved in unwanted direction when colliding with things.
	...
	private Vector3 ApplyGravityAndJumping(Vector3 velocity)
	{
		...
		else
		{
			...
			if(jumping.jumping && jumping.holdingJumpButton)
			{
				...
				//If we're still less than the duration after the jumping time, apply the force.
	...
	private IEnumerator SubtractNewPlatformVelocity()
	{
			...
			)
		{
			if(movingPlatform.newPlatform)
			{
				...
				//If there are problems with platforms, check here.
